...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>OpenClaw — Cross-Border Fraud Detection Assistant</title>
      ...
      <div style={{ fontFamily: '"Inter", sans-serif', backgroundColor: '#0A0A0A', color: '#FFFFFF', margin: 0 }}>
        <nav style={{
          ...
          <div style={{ fontFamily: '"Inter", sans-serif', fontSize: '13px', fontWeight: 600, color: '#FFFFFF', textTransform: 'uppercase', letterSpacing: '0.15em' }}>OpenClaw</div>
        ...
        <section id="overview" ref={setRef('overview')} style={{ ...fadeStyle, minHeight: '100vh', backgroundColor: '#0A0A0A', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 40px', position: 'relative' }}>
          <div style={{ fontFamily: '"Inter", sans-serif', fontSize: '11px', color: '#C8102E', textTransform: 'uppercase', letterSpacing: '0.25em', marginBottom: '24px' }}>AI NATIVE ENTERPRISE — TEAM 25</div>
          <h1 style={{ fontFamily: '"Playfair Display", serif', fontSize: '80px', fontWeight: 700, color: '#FFFFFF', lineHeight: 1.1, maxWidth: '800px', margin: 0 }}>Cross-Border Fraud Detection Assistant</h1>
          ...
          <div style={{ maxWidth: '1100px', width: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '120px', alignItems: 'center' }}>
            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px', marginTop: '48px' }}>
                ...
                <div><div style={{ fontFamily: '"Playfair Display", serif', fontSize: '48px', fontWeight: 700, color: '#C8102E' }}>2.4s</div><div style={{ fontFamily: '"Inter", sans-serif', fontSize: '13px', color: '#888888', marginTop: '8px', lineHeight: 1.5 }}>average time OpenClaw needs to flag a suspicious transaction</div></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="technology" ref={setRef('technology')} style={{ ...fadeStyle, minHeight: '100vh', backgroundColor: '#0A0A0A', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 40px' }}>
          ...
          <p style={{ fontFamily: '"Inter", sans-serif', fontSize: '17px', color: '#888888', lineHeight: 1.8, margin: 0, marginBottom: '48px', maxWidth: '700px', textAlign: 'center' }}>Before any cross-border transaction is approved, OpenClaw builds a complete risk profile of the counterparty. This includes sanctions screening, politically exposed person checks, corporate ownership structure analysis, and adverse media monitoring across global news sources.</p>
        ...
        <section style={{ ...fadeStyle, minHeight: '100vh', backgroundColor: '#FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 40px' }}>
          <div style={{ maxWidth: '1100px', width: '100%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
            <div>
              <div style={{ fontFamily: '"Inter", sans-serif', fontSize: '11px', color: '#C8102E', textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: '16px' }}>AI-NATIVE LOGIC</div>
              <div style={{ width: '40px', height: '1px', backgroundColor: '#C8102E', margin: '16px 0 32px' }} />
              <h2 style={{ fontFamily: '"Playfair Display", serif', fontSize: '44px', fontWeight: 700, color: '#0A0A0A', lineHeight: 1.2, margin: 0 }}>This is not AI as a feature. This is AI as the foundation.</h2>
            </div>
            <div>
              <p style={{ fontFamily: '"Inter", sans-serif', fontSize: '16px', color: '#0A0A0A', lineHeight: 1.8, margin: 0, marginBottom: '24px' }}>We are designing an AI-native fraud detection assistant for international financial institutions because traditional fraud monitoring systems are too slow and limited to detect evolving cross-border fraud patterns effectively.</p>
              <p style={{ fontFamily: '"Inter", sans-serif', fontSize: '16px', color: '#0A0A0A', lineHeight: 1.8, margin: 0 }}>This concept is AI-native: the platform core value depends on continuous AI-driven fraud prediction, behavioural analysis, and adaptive monitoring — not optional AI features layered onto an existing workflow.</p>
            </div>
          </div>
        </section>
          ...
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0px' }}>
              <div style={{ borderLeft: '3px solid #0A0A0A', paddingLeft: '40px' }}>
                <div style={{ fontFamily: '"Inter", sans-serif', fontSize: '11px', color: '#888888', textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: '24px' }}>WHAT SURVIVES WITHOUT AI</div>
              ...
              <div style={{ borderLeft: '3px solid #C8102E', paddingLeft: '40px' }}>
                <div style={{ fontFamily: '"Inter", sans-serif', fontSize: '11px', color: '#C8102E', textTransform: 'uppercase', letterSpacing: '0.2em', marginBottom: '24px' }}>WHAT COLLAPSES WITHOUT AI</div>
        ...
        <section id="team" ref={setRef('team')} style={{ ...fadeStyle, minHeight: '100vh', backgroundColor: '#FFFFFF', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 40px' }}>
          ...
          <h2 style={{ fontFamily: '"Playfair Display", serif', fontSize: '52px', fontWeight: 700, color: '#0A0A0A', textAlign: 'center', margin: 0, marginBottom: '80px' }}>Team 25 — AI Native Enterprise Track</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', maxWidth: '900px', width: '100%' }}>
            {[{role:'Role A',name:'Emmanuel',desc:'Business Logic',resp:'Owns the product logic, use case definition, and AI decision framework.'},{role:'Role B',name:'Sasha',desc:'Workflow & Risk',resp:'Designs the compliance workflow, risk scoring thresholds, and escalation protocols.'},{role:'Role C',name:'Denis',desc:'Prototype & Tools',resp:'Builds and deploys the live prototype, manages GitHub and OpenClaw integration.'}].map((card) => (
        ...
        <footer style={{ backgroundColor: '#0A0A0A', borderTop: '1px solid #C8102E', padding: '48px 40px' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', alignItems: 'center', gap: '40px' }}>
            <div>
              <div style={{ fontFamily: '"Inter", sans-serif', fontSize: '12px', color: '#FFFFFF', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Cross-Border Fraud Detection Assistant</div>
              <div style={{ fontFamily: '"Inter", sans-serif', fontSize: '11px', color: '#888888', marginTop: '8px' }}>AI Native Enterprise — Team 25 — Geneva Business School</div>
            </div>
            <div style={{ display: 'flex', gap: '32px', justifyContent: 'center' }}>
              {['GitHub', 'Live App', 'OpenClaw Workbench'].map((link) => (
                <a key={link} href={link === 'GitHub' ? 'https://github.com/DigitalCoa-ch/ai-native-team-25' : link === 'Live App' ? 'https://team-25.apps.digitalcoa.ch' : '#'} style={{ fontFamily: '"Inter", sans-serif', fontSize: '12px', color: '#888888', textTransform: 'uppercase', textDecoration: 'none', transition: 'color 0.2s ease' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = '#C8102E')}
                  onMouseLeave={(e) => (e.currentTarget.style.color = '#888888')}
                >{link}</a>
              ))}
